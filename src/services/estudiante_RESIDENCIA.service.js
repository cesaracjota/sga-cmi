...
const getAllEstudiantes = async (token, desde, hasta) => {
    ...
    const response = await axios.get(`${API_URL}/estudiantes_residencia`, config);
    return response.data;
}

const getEstudiante = async (id) => {
    const response = await axios.get(`${API_URL}/estudiantes_residencia/${id}`);
    return response.data;
}

const getEstudianteByDni = async (dni) => {
    const response = await axios.get(`${API_URL}/estudiantes_residencia/dni/${dni}`);
    return response.data;
}

const getEstudianteSearch = async (search) => {
    const response = await axios.get(`${API_URL}/estudiantes_residencia/search/${search}`);
    return response.data;
}
...
const createEstudiante = async (data, token) => {
    ...
    const response = await axios.post(`${API_URL}/estudiantes_residencia`, data, config);
...
const updateEstudiante = async (data, token) => {
    ...
    const response = await axios.put(`${API_URL}/estudiantes_residencia/${data._id}`, data, config);
...
const deleteEstudiante = async (id, token) => {
    ...
    const response = await axios.delete(`${API_URL}/estudiantes_residencia/${id}`, config);
    if (response.status === 200 || response.status === 201) {
