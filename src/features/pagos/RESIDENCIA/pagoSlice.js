...
import pagoService from "../../../services/pago_residencia.service";
...
export const getPagoByStudent = createAsyncThunk(
    "pago_residencia/get_by_student",
...
export const updateEstadoPago = createAsyncThunk(
    "pagos_residencia/updateEstadoPago",
    async (data, thunkAPI ) => {
        try {
            const token = thunkAPI.getState().auth.user.token;
