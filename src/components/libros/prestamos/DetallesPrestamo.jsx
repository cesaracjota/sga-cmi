        ...
        <>
            ...
            >
                ...
                <DrawerContent _dark={{ bg: "primary.1000" }}>
                    <DrawerHeader fontWeight="bold" bg="purple.600" color="gray.200" textAlign="center">INFORMACIÓN DEL PRÉSTAMO</DrawerHeader>
                    <DrawerBody>
                            ...
                            <Stack direction={{ base: "column", lg: "row" }} w="full" justifyContent="stretch" spacing={6}>
                                ...
                                <Stack direction="column" mt={6} spacing={4} w="full">
                                    ...
                                    <Stack spacing={4} direction={{ xs: "column", sm: "column", md: "row", lg: "row" }} justifyContent="space-between">
                                        ...
                                        <Badge
                                            colorScheme={libro_prestamo?.estado === 'PRESTADO' ? 'green' : 'blue'}
                                            variant="solid"
                                            px={6}
                                            py={1.5}
                                            rounded="full"
